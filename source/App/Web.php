...
//            if (request_limit("weblogin", 3, 60 * 1)) {
//                $json['message'] = $this->message->error("Você já efetuou 3 tentativas, esse é o limite. Por favor, aguarde 1 minutos para tentar novamente!")->render();
//                echo json_encode($json);
//                return;
//            }
